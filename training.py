...
steps_per_epoch_val = 25
epochs_val = 10
imageDimesions = (32, 32, 3)
testRatio = 0.2  # if 1000 images split will 200 for testing
validationRatio = 0.5  # if 1000 images 20% of remaining 800 will be 160 for validation
learningRate = 0.001
###################################################
...
X_test, X_validation, y_test, y_validation = train_test_split(X_test, y_test, test_size=validationRatio)

############################### COUNTING DATA
# df_tr = pd.DataFrame({"path":X_train,"tag":y_train,"set":"train"})
# df_te = pd.DataFrame({'path':X_test,'tag':y_test,'set':'test'})
# df_val = pd.DataFrame({'path':X_validation,'tag':y_validation,'set':'validation'})
#
# hasil1 = df_tr.flatten()
# hasil2 = df_te.flatten()
# hasil3 = df_val.flatten()
#
# print('Train Size', hasil1)
# print('Val Size', hasil3)
# print('Test Size', hasil2)
